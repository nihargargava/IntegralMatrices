...
# Adapted from PalomarRegistry/PalomarTemplate's pinned Comparator script.
# The verifier revisions are explicit so the check is reproducible.
...
# This revision is the Lean 4.34.0-rc2 branch of lean4export.
lean4export_commit=483e011449cce37c3f8ad5e2aae434cbb1d2e53c
