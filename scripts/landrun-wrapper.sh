...
# Adapted from PalomarRegistry/PalomarTemplate's pinned Comparator wrapper.
# Landrun needs an explicit outer `--`; unsafe sandbox-disabling flags are
# rejected so a verifier update cannot silently widen the sandbox.
