...
Equation (5) (submission PDF p. 3), and the Grassmannian definition
...
Equation (14) (submission PDF p. 12) and Equation (15) (submission PDF p. 12).

## Provenance

* **paper:** submission PDF p. 2.
...
/- [Lean infrastructure, submission PDF p. 11] The literal matrix product
...
/- [Lean infrastructure, submission PDF p. 11] Real linearity of `x ↦ xD`.
...
/- [derived consequence, submission PDF p. 11] Full row rank of a reduced
...
/- [derived consequence, submission PDF p. 11] The image of `x ↦ xD` lies
...
/- [Lean infrastructure, submission PDF p. 11] The coordinate map with its
...
/- [derived consequence, submission PDF p. 11] The literal coordinate map is
...
/- [Lean infrastructure, submission PDF p. 11] The exact real-linear
...
/- [Lean infrastructure, paper equation (15) (submission PDF p. 12)]
...
Jacobian in submission PDF p. 11; defining it as a push-forward keeps the
normalization exact. -/
...
/- [derived consequence, paper equation (15) (submission PDF p. 12)]
...
/- [Lean infrastructure, paper Equations (4) (submission PDF p. 2) and
Equation (15) (submission PDF p. 12)] The literal coefficient
lattice
...
/- [derived consequence, paper definition Equation (4) (submission PDF p. 2)]
...
/- [Lean infrastructure, paper definition Equation (4) (submission PDF p. 2)]
...
/- [derived consequence, submission PDF p. 10] Membership in
...
/- [Lean infrastructure, submission PDF p. 10] The full coefficient module
...
/- [derived consequence, submission PDF p. 10] The product integer module
...
/- [Lean infrastructure, paper equation (11) (submission PDF p. 10)]
...
/- [Lean infrastructure, paper equation (11) (submission PDF p. 10), and
Equation (5) (submission PDF p. 3)] The manuscript's Lebesgue measure on the
...
/- [derived consequence, paper equation (11) (submission PDF p. 10)]
...
/- [paper, equation (11) (submission PDF p. 10)] The full product lattice of
...
/- [derived consequence, paper definition Equation (4) (submission PDF p. 2),
and equation (15) (submission PDF p. 12)] The exact index calculation,
...
/- [derived consequence, submission PDF p. 11] The Jacobian is absorbed exactly
...
/- [derived consequence, paper Equations (4) (submission PDF p. 2) and
Equation (15) (submission PDF p. 12)] Once the exact covolume/index
...
/- [derived consequence, paper Equations (4) (submission PDF p. 2) and
Equation (15) (submission PDF p. 12)] Equivalent source-lattice
...
/- [paper, equation (5) (submission PDF p. 3)] Exact manuscript
...
/- [paper, Lemma 24 (submission PDF pp. 11--12)] The
...
Theorem 42 limit expression (submission PDF p. 24)] The manuscript's limiting
...
/- [derived consequence of paper equation (5) (submission PDF p. 3),
and Theorem 42 (submission PDF p. 24; proof pp. 24--25)] The row-space limit used
