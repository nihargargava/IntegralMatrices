...
submission PDF p. 16] The manuscript cutoff `X` is real, while Schmidt's ordinary
...
/- [derived consequence of submission PDF p. 11 and Corollary 34 (submission PDF p. 16),
submission PDF p. 16] This is `weighted_height_tsum_tail_inv_pow_le` with the
...
/- [Lean infrastructure for paper Corollary 34 (submission PDF p. 16)] Exact bridge
...
submission PDF p. 16] This is the manuscript's echelon height lower bound with its
...
Lemma 33 (submission PDF p. 15)] The preceding uniform echelon
...
/- [derived consequence of paper Corollary 34 (submission PDF p. 16), used in the
final assembly at submission PDF p. 20, specifically Theorem 2 proof, tail estimate (submission PDF p. 20) at
submission PDF p. 20] Uniform height-tail input for the exact `boundedRowSpaces` family.
...
degree-one, rank-one exceptional case of submission PDF p. 21 it specializes to
...
/- [derived consequence of paper Corollary 34 (submission PDF p. 16), and the final
assembly Theorem 2 proof, tail estimate (submission PDF p. 20) within submission PDF p. 20]
...
For the exceptional degree-one/rank-one assembly at submission PDF p. 21, the
