...
This file begins the formalization of Definition 25 (submission PDF p. 12).
...
/- The first minimum is the paper's `l₁`, provided the lattice has a nonzero
   ...
   clause of Lemma 27 (submission PDF pp. 12--13). -/
...
/- The `K`-span of the previously selected vectors, matching the `K · l_i`
   notation in Definition 25 (submission PDF p. 12).  The scalar type is kept
...
/- Definition 25 (submission PDF p. 12), with the manuscript's number-field
...
/- The `K_ℝ`-span of the selected minima is the full real row span.  This is
   the span identity used in the proof of part 2 of Lemma 27 (submission PDF pp. 12--13); the
...
/- [derived consequence of the finite-dimensional realization of `K_ℝ`] For
   ...
   subspace, as required by part 2 of Lemma 27 (submission PDF pp. 12--13). -/
...
/- [Lean infrastructure for the manuscript's `K_ℝ · l_i` and `π_i`]
   ...
   `K`-span from Definition 25 (submission PDF p. 12). -/
...
/- [derived consequence] Combining the exact Fieker--Stehlé conversion with
   ...
   minima gives the displayed product estimate in Lemma 27 (submission PDF pp. 12--13).
...
/- This is the first inequality in part 1 of Lemma 27 (submission PDF pp. 12--13), with the
