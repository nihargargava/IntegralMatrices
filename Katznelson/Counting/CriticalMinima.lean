...
projection-slab lattice count displayed at PDF p. 22 using the same
...
/- [Lean infrastructure for paper PDF p. 22] In degree
...
/- [paper: displayed slab count, PDF p. 22] This is the manuscript's
