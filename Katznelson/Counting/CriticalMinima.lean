...
projection-slab lattice count displayed at submission PDF p. 22 using the same
...
/- [Lean infrastructure] Euclidean volume of a projection slab is bounded
   ...
   the paper's slab at submission PDF p. 22. -/
...
/- [Lean infrastructure] Fundamental-domain counting in a projection slab.
   ...
   back to the exact ambient lattice and projection of paper printed pages
   submission PDF p. 22. -/
...
/- [Lean infrastructure for submission PDF p. 22] In degree
...
/- [paper: displayed slab count (submission PDF p. 22)] This is the manuscript's
