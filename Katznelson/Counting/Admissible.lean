...
This file encodes Hypothesis 16 (submission PDF p. 8) in `authoritative submission PDF` using
...
discriminant-scaled trace metric of Equation (11) (submission PDF p. 10).  The exact manuscript Haar
