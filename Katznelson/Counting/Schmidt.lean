...
second attribution of Schmidt’s original argument.
   ...
   row-space discussion in submission PDF p. 11 of `authoritative submission PDF`.  The
...
/- This is the height-cutoff family corresponding to the manuscript's crude
   estimate `H(D) ≤ C T^(k d)` (submission PDF p. 15).  The identification of the
...
/- [derived consequence, submission PDF p. 10] This is the finite Abel
...
/- [derived consequence, submission PDF p. 10] A quantitative ordinary-shell
...
/- [derived consequence, submission PDF p. 10] On a positive interval the
...
/- [derived consequence, submission PDF p. 10] The borderline case is the
...
/- [derived consequence, submission PDF p. 10] The improper integral which
...
/- [derived consequence, submission PDF p. 10 and corollary Corollary 34 (submission PDF p. 16)]
...
/- [Lean infrastructure] The height interval occurring on the left side of
   the manuscript's first shell estimate (submission PDF p. 10). -/
...
/- [derived consequence, submission PDF p. 10] A bounded height interval is
...
/- [derived consequence, submission PDF p. 10] This is the paper's first
...
/- [derived consequence, submission PDF p. 10] The cumulative cardinality of
...
/- [derived consequence, submission PDF p. 10] The Abel formula uses the
...
/- [derived consequence, submission PDF p. 10] Applying the quantitative Abel
...
/- [derived consequence, submission PDF p. 10] A finite ordinary-shell sum
...
/- [derived consequence, submission PDF p. 10] Abel summation upgrades the
...
/- [derived consequence, submission PDF p. 11 and corollary Corollary 34 (submission PDF p. 16)]
...
/- [derived consequence, submission PDF p. 11 and equation
...
/- [derived consequence, submission PDF p. 11] The paper's height is expected
